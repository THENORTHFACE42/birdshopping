...
<div class="dtree">
	...
	//参数说明年
	//d.add('当前节点id','父级节点id','显示的名称','跳转的链接','鼠标放上去显示的名称','打开显示的位置')
	//当为根节点时，父级节点的id为-1
		...
		d.add('0104','01','商品管理');
		d.add('010402','0104','商品管理','${pageContext.request.contextPath}/adminProduct?method=findAll&currPage=1','','mainFrame');
		d.add('0105','01','订单管理');

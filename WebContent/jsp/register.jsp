...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		<font>会员注册</font>USER REGISTER <b style="color:red">${msg}</b>
		<form class="form-horizontal" style="margin-top:5px;" action="${pageContext.request.contextPath }/user?method=regist" method="post">
			...
			<label class="radio-inline">
			  ...
			  <div class="form-group">
			    <label for="date" class="col-sm-2 control-label" name="code">验证码</label>
			    <div class="col-sm-3">
...
<%-- 			    <img src="${pageContext.request.contextPath}/image/captcha.jhtml"/> --%>
					<img alt="验证码" src="${pageContext.request.contextPath}/code" onclick="changeImg(this)">
			    </div>
